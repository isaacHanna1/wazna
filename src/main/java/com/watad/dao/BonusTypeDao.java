...
public interface BonusTypeDao {
    ...
    List<BonusType> findAll(int churchId , int MeetingId,String evaluationType,boolean active);
    ...
    List<BonusTypeDto> findAllByAttendance(int churchId , int meetingId , String evaluationType, String  physicalAttendanceRequired);
}
