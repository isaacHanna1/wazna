...
public interface YouthRankDao {
    ...
    List<YouthRankDto> getYouthRankWithImage(int sprintId , int churchId , int meetingId ,String userRoles , int limit , int offset);
    List<YouthRankDto> getYouthRankWithImageByUserName(int sprintId , int churchId , int meetingId ,String userRoles , int limit ,String userName);
