...
public interface WaznaReportDao {
    ...
    List<DailyWaznaReport> viewReportOfWaznaAddedToUsers(int sprintId,int churchId,int meetingId, LocalDate startFromDate , LocalDate endToDate , String profileId ,String point_source_type , String waznaType , String bounce_type_filter ,String service_class,int pageNum , int pageSize);
